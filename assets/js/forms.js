...
var FORMS_API_FIELD = {
    ...
    t_formsApi__getContactMethodField = function t(e) {
        ...
        return r.getValue = function() {
            ...
            var t, e = r.element.querySelector(".t-contact-method__value-container > :not(.t-contact-method__hidden)").querySelector(".t-input-block:not(.t-contact-method__hidden)"),
    ...
    t_formsApi__getRangeField = function t(e) {
        try {
            ...
            return r.reset = function() {
                ...
                n.call.apply(n, [this].concat(e)), null == o || o.dispatchEvent(new CustomEvent("displayChanged"))
            }, r
        } catch (a) {
    ...
    t_formsApi__clearForm = function t(e) {
        try {
            return Promise.resolve(_catch$1((function() {
                if (!(e instanceof HTMLFormElement)) throw new Error("Must be called on a form element");
                ...
                return Promise.resolve(Promise.allSettled(o)).then((function(r) {
                    ...
                    })), t_formsApi__isConditionalForm(e) && t.dispatchEvent(new CustomEvent("sync-conditionals", {
                        detail: {
...
var t_forms__updateAllVariables = function t(e) {
        try {
            var r = _catch((function() {
                var t = e.closest(".t-rec"),
                    r = t_forms__getUsedVariables([t], {
                        unique: !0
                    }),
                    o;
                ...
                var n, a = r.filter((function(t) {
                    ...
                    try {
                        ...
                        return r ? Promise.resolve(t_formsApi__initTildaField(r)).then((function(r) {
                            return r ? (t_forms__updateInputVariable(t, e, r), Promise.resolve()) : Promise.resolve()
                        })) : Promise.resolve()
                    } catch (o) {
    ...
    t_forms__focusInput = function t(e) {
        try {
            ...
            var o = _catch((function() {
                return Promise.resolve(t_formsApi__initTildaField(r)).then((function(t) {
                    t.focus()
                }))
            }), (function() {
                e.focus()
...
function t_forms__initForms() {
    var t = document.querySelectorAll('.r:not([data-record-type="1093"], [data-parenttplid="1093"])');
    ...
    Array.prototype.forEach.call(t, (function(t) {
        ...
        if (!window.initForms[o]) {
            ...
            if (t_forms__initFormFields(t), t_forms__initEventPlaceholder(t), t_forms__addInputItsGood(t), t_forms__addAttrAction(t), t_forms__onSubmit(t), t_forms__onClick(t), t_forms__onRender(t), n && t_forms__initFormMutationListeners(t), t_forms__addFocusOnTab(t), t_onFuncLoad("t_throttle", (function() {
                    window.addEventListener("resize", t_throttle((function() {
                        t_forms__calculateInputsWidth(o)
                    })))
                })), window.initForms[o] = !0, n && t_forms__isNewSuccessBox(n)) {
        ...
        if (n) {
            ...
            if (o.tildaSendingStatus && (s = o.tildaSendingStatus), !(s && s >= 1 || t_hasClass(o, "t706__submit_disable")))
                if (t_addClass(o, "t-btn_sending"), o.tildaSendingStatus = "1", window.tildaForm.hideErrors(n), i = window.tildaForm.validate(n), window.tildaForm.showErrors(n, i)) t_removeClass(o, "t-btn_sending"), o.tildaSendingStatus = "0";
                    ...
                    var l, c = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
...
function t_forms__initFormMutationListeners(t) {
    t && (t_removeEventListener(t, "tildaform:contentchanged", t_forms__onFormContentChanged), t_addEventListener(t, "tildaform:contentchanged", t_forms__onFormContentChanged))
}

function t_forms__onFormContentChanged(t) {
    var e;
    t_forms__recalcCoverHeightByFormMutation(t && t.target ? t.target : this)
}

function t_forms__recalcCoverHeightByFormMutation(t) {
    var e = t && t.closest ? t.closest("form") : null,
        r;
    if ((!e && t && t.querySelector && (e = t.querySelector("form")), e) && e.closest(".t-cover")) {
        var o = e.closest(".r");
        if (o && o.id && 0 === o.id.indexOf("rec")) {
            var n = o.id.replace("rec", "");
            n && t_onFuncLoad("t_cover__recalcContentHeight", (function() {
                t_cover__recalcContentHeight(n, !1, 0)
            }))
        }
    }
}
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    }, window.t_forms__clearForm = t_formsApi__clearForm, window.t_forms__updateAllVariables = t_forms__updateAllVariables, window.t_forms__fieldApi = t_formsApi__initTildaField, t_onReady((function() {
        ...
        t_forms__initForms(), t_forms__processGetParameters(), Array.from(document.querySelectorAll('.t396__elem[data-elem-type="form"]:not(.zero-form-rendered)')).forEach((function(t) {
        ...
        if (n || a || i) {
            ...
            if (!document.head.querySelector('script[src*="' + s + '"]')) {
                ...
                l.type = "text/javascript", l.src = "https://static.tildacdn." + t_forms__getRootZone() + "/js/" + s + ".min.js", l.onerror = function() {
        ...
        if ("RU" !== c && "EN" !== c) {
            ...
            if (!document.head.querySelector('script[src*="' + u + '"]')) {
                ...
                d.type = "text/javascript", d.src = "https://static.tildacdn." + t_forms__getRootZone() + "/js/" + u + ".min.js", d.onerror = function() {
        ...
        for (var e, r = t_forms__getElement(t), o = r.querySelectorAll(".js-tilda-rule"), n = [], a = !0, i = r.getAttribute("data-formcart"), s, l = t_forms__getConditionCheckHandler(r).isHiddenByCondition, c = 0; c < o.length; c++) {
            var u = o[c];
            if (!l(u)) {
                var d = !!parseInt(u.getAttribute("data-tilda-req") || 0, 10),
                    m = u.getAttribute("data-tilda-rule") || "none",
                    _, f, p = u.getAttribute("data-tilda-rule-minlength") || 0,
                    w = u.getAttribute("data-tilda-rule-maxlength") || 0,
                    v = {},
                    h = u.value,
                    g = "",
                    y = u.getAttribute("type"),
                    b = u.getAttribute("name");
                v.obj = u, v.type = [], h && h.length && (g = h.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), h = h.trim()), p && (p = parseInt(p, 10)), w && (w = parseInt(w, 10));
                var E = !h.length && !g.length,
                    F = "checkbox" === y || "radio" === y,
                    A = r.querySelectorAll('[name="' + b + '"]:checked').length,
                    x = u.classList.contains("t-checkboxes__hiddeninput");
                if (x || "radio" === y) {
                    var S = x ? "checkbox" : "radio",
                        C = u.closest(".t-input-block"),
                        T = C && C.querySelector(".t-input__own-answer-input, .t-" + S + "-ownanswer");
                    if (T && T.checked) {
                        var k = C.querySelector(".t-input__own-answer, .t-input-ownanswer"),
                            L;
                        k && !k.value.trim() && (t_forms__validateOwnVariant(k), E = !0)
                    }
                }
                if ((h.length && !F || F && A) && (a = !1), d && (E || F && !A)) v.type.push("req");
                else {
                    switch (m) {
                        case "email":
                            _ = /^(?!\.)(?!.*\.\.)[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\.\-\+]{0,63}[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\-\+]@[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,11}$/gi, h.length && !h.match(_) && v.type.push("email");
                            break;
                        case "url":
                            if (_ = /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я0-9][a-zA-Zёа-яЁА-Я\-0-9]{1,10}\/?$/gi, h.length)
                                if ((f = (f = (f = h.split("//")) && f.length > 1 ? f[1] : f[0]).split("/")) && f.length && f[0]) {
                                    if (!(f = f[0]).match(_)) {
                                        var I = /^[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9]([a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\-]|xn--)*(\.[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9\-]+)+$/i,
                                            j;
                                        (/xn--/.test(f) || /[^\x00-\x7F]/.test(f)) && f.match(I) || v.type.push("url")
                                    }
                                } else f && !f[0] || v.type.push("url");
                            break;
                        case "phone":
                            var D = u.getAttribute("data-tilda-mask"),
                                M = "^[0-9()+-";
                            D && (-1 !== D.indexOf("*") ? M += "a-zёа-я" : (-1 !== D.indexOf("a") && (M += "a-z"), -1 !== D.indexOf("а") && (M += "а-яё"))), M += "]+$", _ = new RegExp(M, "gi"), (g.length && !g.match(_) || 1 == (f = g.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == f.indexOf("111") && "9" != f.substring(0, 1) || 1 == f.indexOf("222") && "5" != f.substring(0, 1) || 1 == f.indexOf("333") || 1 == f.indexOf("444") || 1 == f.indexOf("5555") && "0" != f.substring(0, 1) || 1 == f.indexOf("666") && "0" != f.substring(0, 1) || 1 == f.indexOf("8888") && "4" != f.substring(0, 1)) && v.type.push("phone");
                            break;
                        case "number":
                            _ = /^[0-9]+$/gi, g.length > 0 && !g.match(_) && v.type.push("number");
                            break;
                        case "date":
                            t_onFuncLoad("t_datepicker__readDateFromInput", (function() {
                                var t = t_datepicker__readDateFromInput(u);
                                g.length > 0 && !window.t_datepicker__isDateValid(t) && v.type.push("date")
                            }));
                            break;
                        case "time":
                            _ = /^[0-9]{2}[:\.][0-9]{2}$/gi, //! TODO: 00:00 - 23:59. Заменить на
                                g.length > 0 && !g.match(_) && v.type.push("time");
                            break;
                        case "name":
                            _ = /^([ЁёäöüÄÖÜßèéûҐґЄєІіЇїӐӑЙйК̆к̆Ӄ̆ӄ̆Ԛ̆ԛ̆Г̆г̆Ҕ̆ҕ̆ӖӗѢ̆ѣ̆ӁӂꚄ̆ꚅ̆ҊҋО̆о̆Ө̆ө̆Ꚍ̆ꚍ̆ЎўХ̆х̆Џ̆џ̆Ꚏ̆ꚏ̆Ꚇ̆ꚇ̆Ҽ̆ҽ̆Ш̆ш̆Ꚗ̆ꚗ̆Щ̆щ̆Ы̆ы̆Э̆э̆Ю̆ю̆Я̆я̆А́а́ЃѓД́д́Е́е́Ё́ёӘ́ә́З́з́И́и́І́і́Ї́ї́ЌќЛ́л́Н́н́О́о́Р́р́С́с́Т́т́У́у́Ӱ́ӱ́Ү́ү́Х́х́Ц́ц́Ы́ы́Э́э́Ӭ́ӭ́Ю́ю́Ю̈́ю̈́Я́я́Ѣ́ѣ́ҒғӺӻҒ̌ғ̌Ј̵ј̵ҞҟҜҝԞԟӨөҎҏҰұӾӿҸҹҌҍҢңҚқҒғӘәҺһІіҰұҮүӨөȺⱥꜺꜻƂƃɃƀȻȼꞒꞓƋƌĐđɆɇǤǥꞠꞡĦħƗɨƗ́ɨ́Ɨ̀ɨ̀Ɨ̂ɨ̂Ɨ̌ɨ̌Ɨ̃ɨ̃Ɨ̄ɨ̄Ɨ̈ɨ̈Ɨ̋ɨ̋Ɨ̏ɨ̏Ɨ̧ɨ̧Ɨ̧̀ɨ̧̀Ɨ̧̂ɨ̧̂Ɨ̧̌ɨ̧̌ᵼɈɉɟɟ̟ʄʄ̊ʄ̥K̵k̵ꝀꝁꝂꝃꝄꝅꞢꞣŁłł̓Ł̣ł̣ᴌȽƚⱠⱡꝈꝉƛƛ̓ꞤꞥꝊꝋØøǾǿØ̀ø̀Ø̂øØ̌ø̌Ø̄ø̄Ø̃ø̃Ø̨ø̨Ø᷎ø᷎ᴓⱣᵽꝐꝑꝖꝗꝘꝙɌɍꞦꞧꞨꞩẜẝŦŧȾⱦᵺꝤꝥꝦꝧɄʉɄ́ʉ́Ʉ̀ʉ̀Ʉ̂ʉ̂Ʉ̌ʉ̌Ʉ̄ʉ̄Ʉ̃ʉ̃Ʉ̃́ʉ̃́Ʉ̈ʉ̈ʉ̞ᵾU̸u̸ᵿꝞꝟw̸ɎɏƵƶA-Za-z\u00C0\u00C0-\u00C3\u00C8-\u00CA\u00CC\u00CD\u00D2-\u00D9\u00DA\u00DD\u00E0-\u00E3\u00E8\u00E9\u00EA\u00EC\u00ED\u00F2-\u00F5\u00F9\u00FA\u00FD\u0102\u0103\u0110\u0111\u0128\u0129\u0168\u0169\u01A0\u01A1\u01AF\u01B0\u1EA0\u1EA1-\u1EF9\u0027\u2019\u0300-\u03FF\u0400-\u04FF\u0500-\u05FF\u0600-\u06FF\u3040-\u30FF\u0041-\u007A\u00C0-\u02B8\uFB1D-\uFB1F\uFB2A-\uFB4E\u0E00-\u0E7F\u10A0-\u10FF\u3040-\u309F\u30A0-\u30FF\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD]{1,})([ЁёäöüÄÖÜßèéûҐґЄєІіЇїӐӑЙйК̆к̆Ӄ̆ӄ̆Ԛ̆ԛ̆Г̆г̆Ҕ̆ҕ̆ӖӗѢ̆ѣ̆ӁӂꚄ̆ꚅ̆ҊҋО̆о̆Ө̆ө̆Ꚍ̆ꚍ̆ЎўХ̆х̆Џ̆џ̆Ꚏ̆ꚏ̆Ꚇ̆ꚇ̆Ҽ̆ҽ̆Ш̆ш̆Ꚗ̆ꚗ̆Щ̆щ̆Ы̆ы̆Э̆э̆Ю̆ю̆Я̆я̆А́а́ЃѓД́д́Е́е́Ё́ёӘ́ә́З́з́И́и́І́і́Ї́ї́ЌќЛ́л́Н́н́О́о́Р́р́С́с́Т́т́У́у́Ӱ́ӱ́Ү́ү́Х́х́Ц́ц́Ы́ы́Э́э́Ӭ́ӭ́Ю́ю́Ю̈́ю̈́Я́я́Ѣ́ѣ́ҒғӺӻҒ̌ғ̌Ј̵ј̵ҞҟҜҝԞԟӨөҎҏҰұӾӿҸҹҌҍҢңҚқҒғӘәҺһІіҰұҮүӨөȺⱥꜺꜻƂƃɃƀȻȼꞒꞓƋƌĐđɆɇǤǥꞠꞡĦħƗɨƗ́ɨ́Ɨ̀ɨ̀Ɨ̂ɨ̂Ɨ̌ɨ̌Ɨ̃ɨ̃Ɨ̄ɨ̄Ɨ̈ɨ̈Ɨ̋ɨ̋Ɨ̏ɨ̏Ɨ̧ɨ̧Ɨ̧̀ɨ̧̀Ɨ̧̂ɨ̧̂Ɨ̧̌ɨ̧̌ᵼɈɉɟɟ̟ʄʄ̊ʄ̥K̵k̵ꝀꝁꝂꝃꝄꝅꞢꞣŁłł̓Ł̣ł̣ᴌȽƚⱠⱡꝈꝉƛƛ̓ꞤꞥꝊꝋØøǾǿØ̀ø̀Ø̂øØ̌ø̌Ø̄ø̄Ø̃ø̃Ø̨ø̨Ø᷎ø᷎ᴓⱣᵽꝐꝑꝖꝗꝘꝙɌɍꞦꞧꞨꞩẜẝŦŧȾⱦᵺꝤꝥꝦꝧɄʉɄ́ʉ́Ʉ̀ʉ̀Ʉ̂ʉ̂Ʉ̌ʉ̌Ʉ̄ʉ̄Ʉ̃ʉ̃Ʉ̃́ʉ̃́Ʉ̈ʉ̈ʉ̞ᵾU̸u̸ᵿꝞꝟw̸ɎɏƵƶA-Za-z\u00C0\u00C0-\u00C3\u00C8-\u00CA\u00CC\u00CD\u00D2-\u00D9\u00DA\u00DD\u00E0-\u00E3\u00E8\u00E9\u00EA\u00EC\u00ED\u00F2-\u00F5\u00F9\u00FA\u00FD\u0102\u0103\u0110\u0111\u0128\u0129\u0168\u0169\u01A0\u01A1\u01AF\u01B0\u1EA0\u1EA1-\u1EF9\u0041-\u007A\u00C0-\u02B8\u0300-\u03FF\u0400-\u04FF\u0500-\u05FF\u0600-\u06FF\u3040-\u30FF\uFB1D-\uFB1F\uFB2A-\uFB4E\u0E00-\u0E7F\u10A0-\u10FF\u3040-\u309F\u30A0-\u30FF\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD\-\'‘ʼ\s\.]{0,})$/gi, h.length && !h.match(_) && v.type.push("name");
                            break;
                        case "nameeng":
                            _ = /^([A-Za-z\s]{1,}((\-)?[A-Za-z\.\s](\')?){0,})*$/i, h.length && !h.match(_) && v.type.push("nameeng");
                            break;
                        case "namerus":
                            _ = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i, h.length && !h.match(_) && v.type.push("namerus");
                            break;
                        case "string":
                            _ = /^[A-Za-zА-Яа-я0-9ЁёЁёäöüÄÖÜßèéûӐӑЙйК̆к̆Ӄ̆ӄ̆Ԛ̆ԛ̆Г̆г̆Ҕ̆ҕ̆ӖӗѢ̆ѣ̆ӁӂꚄ̆ꚅ̆ҊҋО̆о̆Ө̆ө̆Ꚍ̆ꚍ̆ЎўХ̆х̆Џ̆џ̆Ꚏ̆ꚏ̆Ꚇ̆ꚇ̆Ҽ̆ҽ̆Ш̆ш̆Ꚗ̆ꚗ̆Щ̆щ̆Ы̆ы̆Э̆э̆Ю̆ю̆Я̆я̆А́а́ЃѓД́д́Е́е́Ё́ёӘ́ә́З́з́И́и́І́і́Ї́ї́ЌќЛ́л́Н́н́О́о́Р́р́С́с́Т́т́У́у́Ӱ́ӱ́Ү́ү́Х́х́Ц́ц́Ы́ы́Э́э́Ӭ́ӭ́Ю́ю́Ю̈́ю̈́Я́я́Ѣ́ѣ́ҒғӺӻҒ̌ғ̌Ј̵ј̵ҞҟҜҝԞԟӨөҎҏҰұӾӿҸҹҌҍҢңҚқҒғӘәҺһІіҰұҮүӨөȺⱥꜺꜻƂƃɃƀȻȼꞒꞓƋƌĐđɆɇǤǥꞠꞡĦħƗɨƗ́ɨ́Ɨ̀ɨ̀Ɨ̂ɨ̂Ɨ̌ɨ̌Ɨ̃ɨ̃Ɨ̄ɨ̄Ɨ̈ɨ̈Ɨ̋ɨ̋Ɨ̏ɨ̏Ɨ̧ɨ̧Ɨ̧̀ɨ̧̀Ɨ̧̂ɨ̧̂Ɨ̧̌ɨ̧̌ᵼɈɉɟɟ̟ʄʄ̊ʄ̥K̵k̵ꝀꝁꝂꝃꝄꝅꞢꞣŁłł̓Ł̣ł̣ᴌȽƚⱠⱡꝈꝉƛƛ̓ꞤꞥꝊꝋØøǾǿØ̀ø̀Ø̂øØ̌ø̌Ø̄ø̄Ø̃ø̃Ø̨ø̨Ø᷎ø᷎ᴓⱣᵽꝐꝑꝖꝗꝘꝙɌɍꞦꞧꞨꞩẜẝŦŧȾⱦᵺꝤꝥꝦꝧɄʉɄ́ʉ́Ʉ̀ʉ̀Ʉ̂ʉ̂Ʉ̌ʉ̌Ʉ̄ʉ̄Ʉ̃ʉ̃Ʉ̃́ʉ̃́Ʉ̈ʉ̈ʉ̞ᵾU̸u̸ᵿꝞꝟw̸ɎɏƵƶ\u0041-\u007A\u00C0-\u02B8\u0300-\u03FF\u0400-\u04FF\u0500-\u05FF\u0600-\u06FF\u3040-\u30FF\uFB1D-\uFB1F\uFB2A-\uFB4E\u0E00-\u0E7F\u10A0-\u10FF\u3040-\u309F\u30A0-\u30FF\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD,\.:;\"\'\`\-\_\+\?\!\%\$\@\*\&\^\s+]+$/i, h.length && !h.match(_) && v.type.push("string");
                            break;
                        case "chosevalue":
                            var q, P, R, B, O;
                            if ("SELECT" === (null == (e = u) ? void 0 : e.tagName.toUpperCase()))(null == (P = u) ? void 0 : P.value.length) > 0 || v.type.push("chosevalue");
                            else "true" === (null == (B = u) ? void 0 : B.getAttribute("data-option-selected")) || v.type.push("chosevalue");
                            break;
                        case "promocode":
                            "y" !== i || !g.length || !window.tcart || window.tcart.promocode && window.tcart.prodamount_discountsum || v.type.push("promocode");
                            break;
                        case "deliveryreq":
                            v.type.push("deliveryreq");
                            break;
                        case "unauthorized_order":
                            v.type.push("unauthorized_order")
                    }
                    p > 0 && h.length && h.length < p && v.type.push("minlength"), w > 0 && h.length && h.length > w && v.type.push("maxlength")
                }
                v.type && v.type.length && (n[n.length] = v)
            }
        }
        if ("y" === i) {
            var H = window.tcart_minorder > 0,
                V = window.tcart_mincntorder > 0,
                N;
            if (H)
                if ((N = window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : void 0 !== window.tcart.prodamount_withdiscount && window.tcart.promocode && "OK" === window.tcart.promocode.message ? window.tcart.prodamount_withdiscount : window.tcart.prodamount) < window.tcart_minorder) {
                    var U = {
                        obj: {},
                        type: []
                    };
                    U.type.push("minorder"), n.push(U)
                }
            if (V && window.tcart.total < window.tcart_mincntorder) {
                var z = {
                    obj: {},
                    type: []
                };
                z.type.push("minquantity"), n.push(z)
            }
        }
        return a && !n.length && o.length && (n = [{
            obj: "none",
            type: ["emptyfill"]
        }]), n
        ...
        for (var f = 0; f < e.length; f++)
            if (e[f] && e[f].obj) {
                ...
                for (var w = 0; w < e[f].type.length; w++) {
                    var v = e[f].type[w],
                        h = t_forms__getMsg(v);
                    u = "", (l = r.querySelector(".js-rule-error-" + v)) ? l.textContent && l.innerText || !h || -1 !== d.indexOf(h) ? (u = l.textContent || l.innerText, -1 === d.indexOf(u) && (d = d + '<p class="t-form__errorbox-item">' + u + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + h + "</p>" : h && -1 === d.indexOf(h) && (d = d + '<p class="t-form__errorbox-item">' + h + "</p>"), i && (!u && t_forms__getMsg(v + "field") && (u = t_forms__getMsg(v + "field")), !u && h && (u = h), u && a && (c = a.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(c, (function(t) {
        ...
        if (d) {
            ...
            if (Array.prototype.forEach.call(g, (function(t) {
                ...
                if (y && y.length) {
                    var b, E = '.t1093 .t-popup[data-tooltip-hook="' + y[y.length - 1] + '"]',
        ...
        var t = document.getElementById("tildaformsuccesspopup-new"),
            ...
            r, o = e && "block" === getComputedStyle(e).display ? e : t;
        if (o) {
        ...
        if (window.isRedirectError || !s || e || r) {
            var l = window.isRedirectError && s && !e && !r,
                c = !r && !e,
                u = d();
            p(), w(), t_forms__setupCloseHandlers(u, s), m(), setTimeout((function() {
        ...
        function m() {
            t_fadeIn(u), t_addClass(a, "t-body_success-popup-showed"), u.classList.add("t-popup_show"), _(u), t_forms__isIOS() && setTimeout((function() {
                window.tildaForm.lockBodyScroll()
            }), 500)
        }
        ...
        function l() {
            t_forms__handleSuccess(o, {
                successCallback: r,
                successUrl: e
            }), window.tildaForm.clearTCart(o), t_forms__clearFormInputs(o), t_forms__clearFormData(o), (t_forms__isNewSuccessBox(o) || s) && window.t_forms__clearForm(o)
        }
        ...
        var form = t_forms__getElement(formNode),
            ...
            msgContainers, errorBoxes, allError;
                            ...
                            if ("object" == typeof objData) {
                                ...
                                if (objData && objData.error) msgContainers = t_forms__getErrorContainers(form, ""), errorBoxes = msgContainers.errorBoxes, allError = msgContainers.allError, Array.prototype.forEach.call(allError, (function(t) {
                                    ...
                                    if ("y" === dataFormCart && null != (_objData$member = objData.member) && _objData$member.token) {
                                        var _objData$member2, profileName = "tilda_members_profile" + projectId,
                                            memberInfo = {
                                        ...
                                        localStorage.setItem(profileName, JSON.stringify(memberInfo)), localStorage.setItem(profileName + "_timestamp", Math.floor(Date.now() / 1e3).toString()), t_onFuncLoad("t_bd__init", (function() {
                                            t_bd__init(), window.tcart__initAuthAndDelivery(!0, !1)
                                        }))
                                    }
                                    try {
...
function t_forms__showFormErrors(t, e, r) {
    e.type.forEach((function(o) {
        var n = t.querySelectorAll(".js-rule-error-" + o),
            a, i = t_forms__getCustomMessage(t, o) || t_forms__getMsg(o),
            s;
...
function t_forms__getCustomMessage(t, e) {
    ...
    var o = r.getAttribute("data-original-msg"),
        n = o ? o.replace(/\\\'/g, "&#39;") : o;
    if (null != n) return n;
    var a = r ? r.textContent.replace(/\\\'/g, "&#39;") : "";
...
function t_forms__scrollToInputWithError(t) {
    if (t) {
        ...
        if ("none" !== e && r) {
            if (window.isMobile) {
                var o = e.querySelector("input, textarea, select") || e;
                t_onFuncLoad("t_scrollTo", (function() {
                    t_scrollTo(o)
                }))
            }
            t_forms__focusInput(e)
        }
    }
}
...
function t_forms__onSuccess(t) {
    ...
    if (m > window.scrollY || v - u < f - 100) F || n.classList.add(g), f > v && E && setTimeout((function() {
        t_fadeOut(E)
    }), 300);
    else {
        ...
        b && t_forms__scrollBeginForm(_), setTimeout((function() {
            F || n.classList.add(g)
        }), 400)
    }
...
function t_forms__handleRedirect(t, e, r) {
    ...
    if (t_forms__isNewSuccessBox(t)) {
        ...
        function _() {
            window.isRedirectError = !0, s.textContent = "", t_forms__showSuccessbox(t), new MutationObserver((function(t, e) {
        ...
        c = setTimeout((function() {
            try {
                var t = window.location.href;
                m(e), i || (window.tildaForm.handleClosePopup(), u = setTimeout((function() {
                    try {
...
function t_forms__findMatchingTextNodes(t, e) {
    for (var r = [], o = document.createTreeWalker(t, NodeFilter.SHOW_TEXT, {
        ...
        var n = o.currentNode;
        ["SCRIPT", "STYLE"].includes(n.parentElement.tagName) || n.parentElement.classList.contains("tn-atom__inputs-textarea") || r.push(n.parentElement)
    }
...
function t_forms__isNewSuccessBox(t) {
    return !!t && (!t_forms__isQuiz(t) && !["t396", "t447", "t651", "t653", "t706", "t708", "t945", "t1122"].some((function(e) {
        return t.closest("." + e)
    })));
    var e, r
}
    ...
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o, n = t_forms__getConditionCheckHandler(t).isHiddenByCondition, a = 0; a < r.length; a++)
        if (!(!r[a].name || r[a].disabled || ["file", "reset", "submit", "button"].indexOf(r[a].type) > -1 || n(r[a])))
            if ("select-multiple" !== r[a].type) {
                ...
                for (var l = r[a].options, c = 0; c < l.length; c++) l[c].selected && e.push({
                    name: l[c].name,
                    value: l[c].value
                });
    return e
...
function t_forms__getFormDataJSON(t) {
    var e = {},
        ...
        o, n = t_forms__getConditionCheckHandler(t).isHiddenByCondition,
        a = function t(r, o) {
...
function t_forms__processFormsInPopup(t, e) {
    ...
    var n = e.closest(".t-rec"),
        a = n.getAttribute("data-parenttplid") || n.getAttribute("data-record-type"),
        i;
    "121" === a && (a = t.querySelector(".t-popup__container").getAttribute("data-popup-type") || "121");
...
function t_forms__isCachedPage() {
    try {
        for (var t = new URL(window.location.href), e = t.hostname, r = t.href, o, n = 0, a = [{
                ...
                domains: ["yandex.ru", "yandexwebcache.net", "archive.today", "archive.ph", "archive.is", "web.archive.org", "ghostarchive.org", "cachedview.com"]
            }]; n < a.length; n++) {
            var i = a[n],
...
function t_forms__showWrongPageUrlMessage(t) {
    ...
    function i(t) {
        t_fadeIn(t), t_addClass(document.body, "t-body_success-popup-showed"), t_forms__isIOS() && setTimeout((function() {
            window.tildaForm.lockBodyScroll()
        }), 500), t_forms__trapFocus(t)
    }
...
function t_forms__processGetParameters(t) {
    if (void 0 === t && (t = {}), window.URLSearchParams && "published" === t_forms__getTildaMode()) {
        var e = new URLSearchParams(window.location.search);
        if (null != e && e.size) {
            var r, o = t.currentTarget,
                n = [".t-select", ".t-input", ".t-rate", ".t-radio", ".t-checkbox", ".t-img-select", ".t-range", ".t-checkboxes__hiddeninput", ".t-img-select__hiddeninput", '[type="hidden"]'];
            o || (n = n.map((function(t) {
                return ".js-form-proccess " + t
            })));
            var a = o || document,
                i = Array.from(a.querySelectorAll(n)),
                s;
            if (i.length) new Set(i.map((function(t) {
                ...
                if (r) {
                    ...
                    (o = t_forms__includeCheckboxesForInputList(o)).forEach((function(t) {
...
function t_forms__includeCheckboxesForInputList(t) {
    return t.reduce((function(t, e) {
        if (e.classList.contains("t-checkboxes__hiddeninput") || e.classList.contains("t-img-select__hiddeninput")) {
            var r = e.closest(".t-input-block"),
                o = Array.from((null == r ? void 0 : r.querySelectorAll(".t-checkbox, .t-img-select")) || []);
            t.push.apply(t, o)
        } else t.push(e);
        return t
    }), [])
...
function t_forms__setGetParameterToField(t, e) {
    if (!["tel", "number", "range"].includes(t.type) || !isNaN(e)) {
        var r = 500;
        ["checkbox", "radio"].includes(t.type) ? l((function() {
            var n, s = e.split(","),
                l = (null == t || null == (n = t.value) ? void 0 : n.trim()) || "";
            s.includes(l) && (t.checked = !0, "checkbox" === t.type && o(), t.classList.contains("t-rate") && a(), "radio" === t.type && t.closest(".t-contact-method__types-container") && i(r))
        })) : "select-one" === t.type ? n() : (t.value = e, t.classList.contains("t-range") && i(), "tel" === t.type && s()), l(i, !1)
    }
    ...
    function n() {
        var r, o = Array.from(t.options).find((function(t) {
    ...
    function a() {
        var e;
        null == (e = t.closest(".t-rate__wrapper")) || e.classList.add("t-rate__wrapper_active")
    }
    ...
    function s() {
        ...
        e && (e = "input_" + e), e || (e = t.id), e && setTimeout((function() {
    ...
    function l(t, e) {
        void 0 === e && (e = !0);
        var r = c();
        (e || r) && (r && "y" !== r.getAttribute("data-init-calc") ? r.addEventListener("inputReady", t) : t())
    }
...
function t_forms__getTildaMode() {
    ...
    var t = document.getElementById("allrecords");
    return t ? (window.tildamode = t.getAttribute("data-tilda-mode") || "published", window.tildamode) : "notdefined"
}