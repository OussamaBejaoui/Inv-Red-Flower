...
function t_scrollBarWidthCompensator__setObject() {
    ...
    var e = ["t450", "t282__container", "t282__container__bg_opened", "t282__menu__container", "t830m", "t830__panel", "t451m", "t204__menu", "tn-atom__sbs-anim-wrapper", "t-menu-popover__burgermenu__sidebar_right", "t-menu-popover_fullscreen"],
    ...
    n = Array.prototype.filter.call(n, (function(t) {
        ...
        if (!e.classList.contains("t975")) {
            var n = window.getComputedStyle(e),
                ...
                i = t_scrollBarWidthCompensator__checkSize(n, t.scrollBarWidth),
                r = i.isFullscreenWidth,
                a = i.isFullscreenHeight;
            ("fixed" === o || "absolute" === o && r && !a) && t.fixedElements.push({
                el: e,
                computedStyle: n
            })
        }
...
function t_scrollBarWidthCompensator__init() {
    if (!window.isMobile && !t_checkIsEditMode()) {
        ...
        if (t.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth), t.cancelTimeout && (window.clearTimeout(t.cancelTimeout), t.cancelTimeout = null), !t.isInited && t.scrollBarWidth) {
            ...
            Array.prototype.forEach.call(t.fixedElements, (function(e) {
                ...
                if (document.body.contains(n) && !n.classList.contains("t975") && !n.classList.contains("t975")) {
                    var i = n.closest(".r"),
                        r = e.computedStyle,
                        a = r.getPropertyValue("position");
                    if ("fixed" === a || "absolute" === a) {
                        var l = r.getPropertyValue("transition-duration");
                        l.indexOf("ms") + 1 ? (l = parseInt(l.replace("ms", ""), 10), o.push(l)) : l.indexOf("s") + 1 && (l = 1e3 * parseFloat(l.replace("s", "")), o.push(l));
                        var d = r.getPropertyValue("right");
                        d = parseInt(d.replace("px", ""), 10);
                        var s = n.style.right;
                        s && n.setAttribute("data-tilda-initial-right", s);
                        var c = n.style.width;
                        c && n.setAttribute("data-tilda-initial-width", c);
                        var u = i && parseFloat(getComputedStyle(i).getPropertyValue("zoom")) || 1,
                            m = t.scrollBarWidth / u,
                            p = t_scrollBarWidthCompensator__checkSize(r, t.scrollBarWidth),
                            h = p.isFullscreenWidth,
                            f = p.isFullscreenHeight,
                            g = p.computedMarginNum;
                        h = h || n.classList.contains("t-menu-popover_fullwidth") || n.classList.contains("t-menu-popover") && u > 1, !d && 0 !== d || "auto" === n.style.right || "absolute" === a || h ? h && !f && (n.style.width = "calc(100vw / " + (window.isSafari ? 1 : u) + " - " + g + "px - " + m + "px)") : n.style.right = m + d + "px"
                    }
                }
...
function t_scrollBarWidthCompensator__checkSize(t, e) {
    var n = window,
        o = n.innerWidth,
        i = n.innerHeight,
        r = t.getPropertyValue("width"),
        a = parseFloat(r) || 0,
        l = t.getPropertyValue("height"),
        d = parseFloat(l) || 0,
        s = t.getPropertyValue("margin-left"),
        c = parseFloat(s) || 0,
        u = t.getPropertyValue("margin-right"),
        m, p = c + (parseFloat(u) || 0),
        h, f;
    return {
        isFullscreenWidth: "100%" === r || "100vw" === r || a === o || a === o - e || a === o - p || a === o - p - e,
        isFullscreenHeight: "100%" === l || "100vh" === l || "auto" === l || d === i || d === i - e,
        computedMarginNum: p
    }
}
...
function t_modifyRootZone(t) {
    return t && t.includes("static.tildacdn.com") ? t.replace("static.tildacdn.com", "static.tildacdn." + t_getRootZone()) : t
}
...
function t_loadCSSFile(t, e, n) {
    ...
    if (document.querySelector('link[href^="' + r + '"]')) e && e();
        ...
        a.rel = "stylesheet", a.type = "text/css", a.media = "all", a.href = r, a.crossOrigin = "anonymous", e && a.addEventListener("load", e), a.addEventListener("error", (function(t) {
            if (!(n <= 3)) {
                var o = t.message || "<no error message>";
            ...
            setTimeout((function() {
                a.remove(), t_loadCSSFile(r, e, n + 1), console.warn("Retrying to load " + r + ". Retry: " + (n + 1))
            }), n * i)
        })), document.head.appendChild(a)
    }
}
...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, t_onReady((function() {
        ...
        if (!window.isMobile && t && "yes" !== t.getAttribute("data-blocks-animationoff") && !1 === window.isSearchBot) {
            for (var e = document.querySelectorAll(".r"), n = 0; n < e.length; n++) {
                ...
                i && -1 !== i.indexOf("background") && o.setAttribute("data-animationappear", "off")
            }
            ...
            if (r.length) {
                ...
                var s = document.querySelectorAll('[data-record-type="400"], [data-parenttplid="400"]');
                ...
                window.addEventListener("scroll", t_throttle((function() {
                    d()
                }), 200)), window.addEventListener("tildatab:change", t_throttle((function() {
                    d()
        ...
        var f = document.querySelector(".t-tildalabel"),
            g;
        (g = h ? Math.max(h.scrollHeight, h.offsetHeight, h.clientHeight, p.offsetHeight) : p.offsetHeight) + 70 < window.innerHeight ? f && (f.style.display = "none") : f && f.setAttribute("style", "display: block !important")
    })),
    function() {
        function t() {
    ...
    function() {
        ...
        function e() {
            ...
            for (var n = 0; n < m.length; n++) {
                var o, i;
                (i = (o = m[n]).style).height.indexOf("vh") > -1 && (e = parseInt(i.height) / 100, d = p * (isNaN(e) ? 1 : e) + "px", i.height = d)
            }
        }
        ...
        function n() {
            ...
            for (var n = document.querySelectorAll('.r:not([data-record-type="396"], [data-record-type="1003"], [data-parenttplid="396"], [data-parenttplid="1003"])'), o = [], i = 0; i < n.length; i++) {
                var r = n[i],
